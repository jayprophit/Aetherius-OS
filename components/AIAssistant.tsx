...
import { XMarkIcon, ChevronLeftIcon, HiveMindIcon, DocumentTextIcon, CodeBracketIcon, PlayIcon, ShareIcon, ArrowUpCircleIcon, PlusCircleIcon, ChevronDownIcon, GitHubIcon, MicrophoneIcon, PuzzlePieceIcon, Cog6ToothIcon, GlobeIcon, CubeTransparentIcon, ArrowsPointingOutIcon, MusicNoteIcon, ImageIcon, VideoIcon, ArrowDownTrayIcon, ClockIcon, GlobeAltIcon, LockClosedIcon, EllipsisHorizontalIcon, MapIcon, PresentationChartLineIcon, ClipboardDocumentCheckIcon } from './Icons';
        ...
        <div className="h-full w-full bg-white dark:bg-gray-800 flex flex-col">
            ...
            {activeTab === 'avatar' && (
                <div className="flex-1 flex flex-col overflow-hidden">
                     <div className="p-2 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between flex-shrink-0">
