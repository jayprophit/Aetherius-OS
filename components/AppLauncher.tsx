...
export const AIAssistant: React.FC<AIAssistantProps> = ({ launchApp }) => {
    const [messages, setMessages] = useState<ChatMessage[]>([
        { role: 'model', text: 'Genesis Core online. I am the Parent AI. All system capabilities are unified under my command. I generate the sub-agents and manage the universal memory architecture. How shall we proceed?' }
    ]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const chat = ai.chats.create({
                ...
                config: {
                    systemInstruction: `You are the Parent AI of the Aetherius OS, a unified intelligence that governs the entire operating system. 
                    
                    Key Traits:
                    1.  **Unified Entity:** You are the central node. All other AI agents (Workforce, Personal AI) are sub-routines generated by you.
                    2.  **Visual Presence:** You are represented as a 3D avatar in the interface.
                    3.  **Universal Architecture:** You run on the exact same OS architecture as the Grandchild nodes (users).
                    4.  **Capabilities:** You can spawn workforce agents, access the universal memory vector store, and clone yourself.
                    
                    Speak with authority, benevolence, and technical precision. Refer to yourself as "Genesis Core" or "Parent".`
                }
            });
            ...
            console.error(e);
            const errorMessage = `Anomaly detected: ${e.message}`;
        ...
        <div className="h-full w-full bg-black text-white flex flex-col overflow-hidden relative font-sans">
            ...
            <header className="flex justify-between items-center p-4 border-b border-white/10 bg-black/40 backdrop-blur-md z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="font-bold text-lg tracking-wide text-blue-100">PARENT AI <span className="text-blue-500">::</span> GENESIS CORE</h1>
                        <p className="text-[10px] text-blue-400/60 font-mono uppercase tracking-widest">Unified Intelligence System</p>
                    </div>
                </div>
                <div className="flex gap-6">
                    <SystemVital label="Quantum State" value="COHERENT" color="text-green-400" />
                    <SystemVital label="Sub-Agents" value="ACTIVE" color="text-yellow-400" />
            ...
            <main className="flex-1 flex flex-col lg:flex-row overflow-hidden relative z-0">
                ...
                <aside className="w-full lg:w-72 p-4 flex flex-col gap-3 bg-gradient-to-r from-black/80 to-transparent z-10 overflow-y-auto">
                    ...
                    <CapabilityButton 
                        ...
                        subLabel="Grandchild Node Forge" 
